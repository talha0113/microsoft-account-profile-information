...
export class FlagComponent implements OnInit, OnDestroy {
    ...
    constructor(private domSanitizer: DomSanitizer, private translocoService: TranslocoService) {}
  ...
  public switchLanguage(): void {
      ...
      StorageManager.add<string>(TranslationConfiguration.languageKey, this.currentLanguage);
  }
}
